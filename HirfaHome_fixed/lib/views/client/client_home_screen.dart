...
// ─── Status helpers (delegating to centralized StatusStyle) ───────────────────
Color _statutColor(String s) => StatusStyle.forStatus(s).foreground;
IconData _statutIcon(String s) => StatusStyle.forStatus(s).icon;
...
class _ClientHomeScreenState extends State<ClientHomeScreen> {
  ...
  /// side for rooms containing the user's UID, then counts unread messages
        ...
        builder: (ctx, snap) {
          ...
          return Scaffold(
                      ...
                      return GestureDetector(
                        onTap: () {
                          final uid =
                              FirebaseAuth.instance.currentUser?.uid ?? '';
                          debugPrint(
                              'ChatInboxScreen: client bubble tapped, uid: $uid');
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) =>
            ...
            bottomNavigationBar: LiquidBottomNav(
              ...
              items: [
                LiquidNavItem(icon: Icons.home_outlined, activeIcon: Icons.home_rounded, label: AppStrings.t('nav_home', lang)),
                LiquidNavItem(icon: Icons.search_outlined, activeIcon: Icons.search_rounded, label: AppStrings.t('nav_search', lang)),
                LiquidNavItem(icon: Icons.assignment_outlined, activeIcon: Icons.assignment_rounded, label: AppStrings.t('nav_demandes', lang)),
                LiquidNavItem(icon: Icons.person_outline_rounded, activeIcon: Icons.person_rounded, label: AppStrings.t('nav_profile', lang)),
              ],
            ),
          );
        },
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: _SectionHeader(
              title: AppStrings.t('home_section_categories', lang),
            ),
          ),
          SliverToBoxAdapter(
          ...
          SliverToBoxAdapter(
            child: _SectionHeader(
              title: AppStrings.t('home_section_nearby', lang),
              actionLabel: AppStrings.t('home_action_view_all', lang),
            ...
            child: Padding(
              ...
              child: GlassContainer(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(AppStrings.t('home_action_new_request', lang)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.transparent,
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Stack(
            children: [
              // Decorative circles — subtle white tints
              Positioned(
                top: -40, right: -40,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Subtitle
                      Text(
                        AppStrings.t('home_subtitle', lang),
                        style: GoogleFonts.inter(
                          fontSize: 15,
                          ...
                          child: GlassContainer(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  AppStrings.t('home_search_prompt_subtitle', lang),
                                  style: GoogleFonts.inter(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          _StatCard(
            count: active,
            label: AppStrings.t('home_stat_active', lang),
            color: AppColors.warning,
          ...
          _StatCard(
            count: done,
            label: AppStrings.t('home_stat_done', lang),
          ...
          _StatCard(
            count: total,
            label: AppStrings.t('home_stat_total', lang),
            color: AppColors.primary,
...
class _DemandesTabState extends State<_DemandesTab>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.transparent,
      appBar: AppBar(
        title: Text(lang == 'ar' ? 'طلباتي' : 'Mes Demandes',
                ...
                child: GlassContainer(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: AppSpacing.xs),
                      // Email chip (subtitle — replaces artisan specialty)
                      if (email.isNotEmpty)
                        Container(
                          padding: const EdgeInsets.symmetric(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(AppStrings.t('geo_error', lang).replaceAll('{error}', e.toString())),
        ));
      }
    }
  }
