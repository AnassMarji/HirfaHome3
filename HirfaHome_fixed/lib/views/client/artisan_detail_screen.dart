...
class _ArtisanDetailScreenState extends State<ArtisanDetailScreen>
  ...
  void _shareProfile() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(AppStrings.t('detail_share_soon', lang))),
    );
  }
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: AppSpacing.xl),
                          // Photo picker
                          Text(AppStrings.t('detail_photos_optional', lang),
                          ...
                          const SizedBox(height: AppSpacing.xl),
                          // Geolocation
                          Text(AppStrings.t('detail_location_optional', lang),
                              style: AppTextStyles.bodyLarge
                                  .copyWith(fontWeight: FontWeight.w600)),
                          const SizedBox(height: AppSpacing.sm),
                          Row(
                                          ...
                                          if (!svc) {
                                            if (context.mounted) {
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(
                                                    content:
                                                        Text(AppStrings.t('detail_enable_gps', lang)),
                          ...
                          SizedBox(
                            ...
                            child: TabBarView(
                              ...
                              children: [
                                ...
                                _buildAvisTab(rating, reviewsCount, lang),
                              ],
                            ),
                          ),
  ...
  Widget _heroFallback() {
    return Container(
      ...
      child: Center(
        child: Icon(Icons.person, color: AppColors.onPrimary.withValues(alpha: 0.5), size: 80),
      ),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(AppStrings.t('detail_availability', lang), style: AppTextStyles.titleMedium),
          const SizedBox(height: AppSpacing.sm),
          _buildAvailabilitySection(availability),
          const SizedBox(height: AppSpacing.xl),
          Text(AppStrings.t('detail_contact', lang), style: AppTextStyles.titleMedium),
          const SizedBox(height: AppSpacing.sm),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Column(
                          children: [
                            Text(AppStrings.t('detail_before', lang),
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            Text(AppStrings.t('detail_after', lang),
                                style: AppTextStyles.overline
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSpacing.base),
              Text(AppStrings.t('detail_no_portfolio', lang),
                  style: AppTextStyles.bodyMedium,
                  textAlign: TextAlign.center),
            ],
          ),
  ...
  Widget _buildAvisTab(double rating, int reviews, String lang) {
    final reviewsLabel = AppStrings.t('artisan_reviews_count', lang)
        .replaceAll('{count}', reviews.toString())
        .replaceAll('{s}', reviews != 1 ? 's' : '');
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(AppSpacing.xxl),
        child: Column(
          ...
          children: [
            ...
            Text(
              rating > 0
                  ? rating.toStringAsFixed(1)
                  : AppStrings.t('artisan_no_rating', lang),
              style: AppTextStyles.headlineMedium,
            ),
            Text(reviewsLabel, style: AppTextStyles.bodyMedium),
            const SizedBox(height: AppSpacing.xxl),
            Text(
              AppStrings.t('artisan_reviews_placeholder', lang),
              style: AppTextStyles.bodyMedium,
              textAlign: TextAlign.center,
            ),
          ],
    ...
    return ClipRect(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: AppSpacing.md),
          // Main CTA — full width orange with glow
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(AppRadius.md),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(AppStrings.t('artisan_cta_send_request', lang),
                      style: const TextStyle(
