      ...
      body: NestedScrollView(
        headerSliverBuilder: (context, _) => [
          ...
          SliverAppBar(
            ...
            title: Text(
              lang == 'ar' ? 'دليل الحرفيين' : 'Annuaire des Artisans',
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Rechercher un artisan, ville…',
                          filled: true,
          ...
          children: [
            ...
            if (!isNoData) ...[
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Modifier vos filtres'),
          ...
          builder: (ctx, setLocal) => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Filtres avancés', style: AppTextStyles.titleMedium),
                const SizedBox(height: AppSpacing.xl),
